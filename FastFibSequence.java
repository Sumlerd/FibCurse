/*==========================================================================
 ...
 |                recursively, and faster than the FibSequence class.
 |
 |        Input:  No input is used for this class.
 |
 |       Output:  No output is generated by this class.
 |
 |      Process:  A FastFibSequence object is created and the next method is
 ...
 |                Prior to making a recursive call to itself, fibCalc checks
 |                the calculatedValues array to see if a number in the
 |                sequence has already been calculated to save time.
 |
...
public class FastFibSequence implements Sequence{
   ...
   private int calculatedValues[];     //stores calclated sequence values
   ...
   *  @return currentValue The current index of the sequence.
   */
   ...
   */
   ...
   /**
   *  Sets the size of the calculateValues array.
   *  @param size The size of the array.
   */
   public void setArrSize(int size){
      calculatedValues = new int[size];
   }
